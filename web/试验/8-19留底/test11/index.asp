...
<div id="aa" class="easyui-accordion" style="width:100%;">
    <div title="新品跟踪" data-options="iconCls:'icon-more',selected:true" class="xl">
		<div class="easyui-linkbutton" onclick="addTab('新品跟踪','xpgz/xpgz.asp')">新品跟踪</div>
		<div class="easyui-linkbutton" onclick="addTab('价格管理','jggl/jggl.asp')">价格管理</div>
		<div class="easyui-linkbutton" onclick="addTab('店铺信息','dpxx/dpxx.asp')">店铺信息</div>
		<div class="easyui-linkbutton" onclick="addTab('厂家供应信息表','cjgyxxb/cjgyxxb.asp')">厂家供应信息表</div>
		<div class="easyui-linkbutton" onclick="addTab('行业搜索记录表','hyssjlb/hyssjlb.asp')">行业搜索记录表</div>
		<div class="easyui-linkbutton" onclick="addTab('利润关键点','lrgjd/lrgjd.asp')">利润关键点</div>
		<div class="easyui-linkbutton" onclick="addTab('销售占比关键点','xszbgjd/xszbgjd.asp')">销售占比关键点</div>
		<div class="easyui-linkbutton" onclick="addTab('一级类别汇总设置','yjlbhzsz/yjlbhzsz.asp')">一级类别汇总设置</div>
		<div class="easyui-linkbutton" onclick="addTab('一级类别售卖周期','yjlbsmzqsz/yjlbsmzqsz.asp')">一级类别售卖周期</div>
    </div>
